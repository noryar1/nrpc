...
import com.noryar.rpc.registry.ServiceDiscovery;
...
/**
 * 类描述:RPC代理（用于创建RPC服务代理）.
 *
 * @author leon.
 */
public class NrpcProxy {

    private String serverAddress;
    private ServiceDiscovery serviceDiscovery;

    public NrpcProxy(String serverAddress) {
        this.serverAddress = serverAddress;
    }

    public NrpcProxy(ServiceDiscovery serviceDiscovery) {
        ...
        return (T) Proxy.newProxyInstance(interfaceClass.getClassLoader(),
                new Class<?>[]{interfaceClass}, new InvocationHandler() {
                    public Object invoke(Object proxy, Method method,
                        ...
                        NrpcClient client = new NrpcClient(host, port);
                        // 通过netty向服务端发送请求
